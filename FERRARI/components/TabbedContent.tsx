...
export const TabbedContent: React.FC = () => {
  ...
  return (
    <div>
      ...
      <div className="bg-white/95 backdrop-blur-lg pt-3 sm:pt-4 md:pt-6 sticky top-0 z-30 shadow-lg border-b border-accent/20">
        <div className="container mx-auto px-3 sm:px-4 md:px-6">
          {/* Mobile: Horizontal scroll, Tablet+: Flex row */}
          <div className="flex overflow-x-auto scrollbar-hide md:flex-row md:justify-center md:overflow-visible gap-2 sm:gap-3 md:gap-0 -mx-3 sm:-mx-4 md:mx-0 px-3 sm:px-4 md:px-0">
            <button
                onClick={() => handleTabClick('ai')}
                className={`${tabStyles} ${activeTab === 'ai' ? 'text-accent border-accent bg-accent/5' : 'text-primary border-transparent hover:text-accent hover:bg-accent/5'} group font-serif flex-shrink-0 min-h-[44px]`}
            ...
            <button
                ...
                className={`${tabStyles} ${activeTab === 'commercial' ? 'text-accent border-accent bg-accent/5' : 'text-primary border-transparent hover:text-accent hover:bg-accent/5'} group font-serif flex-shrink-0 min-h-[44px]`}
                style={{ fontSize: 'clamp(0.75rem, 2vw, 1.125rem)' }}
            >
            ...
            <button
                ...
                className={`${tabStyles} ${activeTab === 'residential' ? 'text-accent border-accent bg-accent/5' : 'text-primary border-transparent hover:text-accent hover:bg-accent/5'} group font-serif flex-shrink-0 min-h-[44px]`}
                style={{ fontSize: 'clamp(0.75rem, 2vw, 1.125rem)' }}
            >
            ...
            <button
                ...
                className={`${tabStyles} ${activeTab === 'land' ? 'text-accent border-accent bg-accent/5' : 'text-primary border-transparent hover:text-accent hover:bg-accent/5'} group font-serif flex-shrink-0 min-h-[44px]`}
                style={{ fontSize: 'clamp(0.75rem, 2vw, 1.125rem)' }}
            >
            ...
            <button
                ...
                className={`${tabStyles} ${activeTab === 'rentals' ? 'text-accent border-accent bg-accent/5' : 'text-primary border-transparent hover:text-accent hover:bg-accent/5'} group font-serif flex-shrink-0 min-h-[44px]`}
                style={{ fontSize: 'clamp(0.75rem, 2vw, 1.125rem)' }}
            >
